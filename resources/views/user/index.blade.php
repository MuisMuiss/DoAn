                                ...
                                <a href="{{ route('productdetail', $pro->san_pham_id) }}">
                                    <div class="rounded position-relative fruite-item">
                                        ...
                                        @foreach ($brand_product as $keybrand => $brand)
                                            @if ($pro->thuong_hieu_id == $brand->thuong_hieu_id)
                                                <div class="text-white bg-secondary px-3 py-1 rounded position-absolute"
                                                    style="top: 10px; left: 10px;">{{ $brand->ten_thuong_hieu }}</div>
                                            @endif
                                        @endforeach
                                        <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                            <h6 style="font-family: 'Arial', sans-serif;">{{ $pro->ten_san_pham }}
                                            </h6>
                                            <div class="d-flex justify-content-between flex-lg-wrap">
                                                <p class=" fw-bold mb-0" style="font-size: 1.10rem; color:red">{{number_format($pro->gia,0, ',', '.')}}VNĐ</p>
                                                <a href="{{ route('cart.add1', $pro->san_pham_id) }}"
        ...
        <div class="row g-4 align-items-center">
            <div class="col-lg-6">
                <div class="py-4">
                    ...
                    <p class="mb-4 text-dark">Khi bạn mua đơn hàng giá trị trên 1 triệu đồng bạn sẽ được khuyến mãi giao hàng tận nơi.</p>
                    {{-- <a href="#"
