...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Bảng dữ liệu chi tiết đơn hàng của "{{ $order->User->ho_ten ?? 'Không xác định' }} đã mua vào ngày {{ date('d/m/Y', strtotime($order->ngay_dat)) }}"</h6>
        </div>
        @if (session('status'))
